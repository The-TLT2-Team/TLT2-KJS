ItemEvents.tooltip(event=>{
    event.add('mekanism:indium_casing',Component.translatable('tooltip.mekanism.hold_for_description',"§bSHIFT+N"))
    event.add('tinkers_advanced:iridium_lean_ore',Component.translatable('tooltip.kubejs.found_in_end'))
