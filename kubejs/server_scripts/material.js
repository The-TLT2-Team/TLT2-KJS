...
ServerEvents.recipes(event=>{
    ...
    //钛
    metalMaterial(["kubejs:titanium","kubejs:molten_titanium","kubejs:titanium_ingot",1250])
})
/**
 * 相关函数(ctrl点击以跳转)：
 * @see buildMaterial
...
//    海洋玻璃碎片
    ...
    .build()
     buildMaterial('tcintegrations','calorite').setTier(6).build()
        ...
        .build()
    //钛
    buildMaterial('kubejs','titanium').setTier(4).build()
        .addStat(MaterialStatIds.HEAD,headStat(2975,3,11,MiningTiers.NETHERITE))
        .addStat(MaterialStatIds.HANDLE,handleStat(0.3,-0.3,0.25,1.15))
        .addStat(MaterialStatIds.PLATING_BOOTS,platingStat(3,1980,0,4))
        .addStat(MaterialStatIds.PLATING_LEGGINS,platingStat(5.75,2259,0,4))
        .addStat(MaterialStatIds.PLATING_CHESTPLATE,platingStat(7,2370,0,4))
        .addStat(MaterialStatIds.PLATING_HELMET,platingStat(3,1925,0,4))
        .addStatlessStat(StatlessStatIds.MAILLE).addStatlessStat(StatlessStatIds.SHIELD_CORE).addStatlessStat(StatlessStatIds.BINDING).build()
        .addDefault("tconstruct:enhanced",1).addDefault("tconstruct:ductile",2)
        .buildPerstat(MaterialTypes.ARMOR).addModifier("tconstruct:melee_protection",1).addModifier("tconstruct:ductile",1).build()
        .build()
})
